# Generated by Django 5.1.8 on 2025-05-30 10:55
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "list_options",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="list options"
                    ),
                ),
                (
                    "condition",
                    models.CharField(
                        blank=True, max_length=400, verbose_name="condition"
                    ),
                ),
                (
                    "formula",
                    models.CharField(
                        blank=True, max_length=400, verbose_name="formula"
                    ),
                ),
                (
                    "validation",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="validation"
                    ),
                ),
                (
                    "message",
                    models.CharField(
                        blank=True, max_length=400, verbose_name="message"
                    ),
                ),
                (
                    "created_by",
                ...
                (
                    "topics",
                    models.ManyToManyField(related_name="topics", to="methods.topic"),
                ),
            ],
            options={
                "abstract": False,
