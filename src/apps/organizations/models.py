...
class Project(BaseModel):
    ...
    organization = models.ForeignKey(
        "organizations.organization", on_delete=models.SET_NULL, blank=True, null=True
    )
    vat_number = models.CharField(_("vat number"), max_length=30)
    name = models.CharField(_("name"), max_length=150)
    description = models.CharField(_("description"), blank=True, max_length=400)
    contact_person = models.CharField(_("contact person"), blank=True, max_length=150)
    ...
    publish_results = models.BooleanField(
        _("I want to make public the results"), max_length=50
    )
